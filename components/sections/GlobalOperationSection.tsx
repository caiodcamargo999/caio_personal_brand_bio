...
export function GlobalOperationSection() {
  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-0 sm:px-4 mt-20 overflow-hidden border border-border/40 rounded-3xl bg-black/40 backdrop-blur-sm min-h-[600px] lg:min-h-[700px]">
      
      {/* Text Content */}
      <div className="relative flex-1 p-8 md:p-16 z-20 pointer-events-auto md:max-w-[60%] lg:max-w-[55%]">
      ...
      <div className="absolute bottom-0 right-[-15%] md:right-0 w-[130%] md:w-[60%] lg:w-[55%] h-[60%] md:h-[95%] z-10 pointer-events-none flex justify-end items-end">
