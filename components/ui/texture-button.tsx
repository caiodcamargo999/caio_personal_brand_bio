...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      primary:
        "w-full border border-[1px] dark:border-[2px] border-black/10 dark:border-fuchsia-900 bg-gradient-to-b from-black/70 to-black dark:from-fuchsia-400 dark:to-fuchsia-600 p-[1px] transition duration-300 ease-in-out",
      accent:
      ...
      secondary:
        "w-full border-[1px] dark:border-[2px] border-black/20 bg-white/50 dark:border-indigo-900 dark:bg-indigo-600/50 p-[1px] transition duration-300 ease-in-out",
      minimal:
...
const innerDivVariants = cva(
  "w-full h-full flex items-center justify-center text-muted-foreground",
  {
    variants: {
      variant: {
        primary:
          "gap-2 bg-gradient-to-b from-neutral-800 to-black dark:from-fuchsia-500 dark:to-fuchsia-700 text-sm text-white/90 dark:text-white transition-all duration-300 ease-in-out hover:from-stone-800 hover:to-neutral-800/70 dark:hover:from-blue-500 dark:hover:to-blue-700 dark:active:from-blue-600 dark:active:to-blue-800 active:bg-gradient-to-b active:from-black active:to-black",
        accent:
        ...
        secondary:
          "bg-gradient-to-b from-neutral-100/80 to-neutral-200/50 dark:from-indigo-800 dark:to-indigo-950 text-sm dark:text-white transition-all duration-300 ease-in-out hover:bg-gradient-to-b hover:from-neutral-200/40 hover:to-neutral-300/60 dark:hover:from-fuchsia-600 dark:hover:to-fuchsia-800 active:bg-gradient-to-b active:from-neutral-200/60 active:to-neutral-300/70 dark:active:from-fuchsia-700 dark:active:to-fuchsia-900",
        minimal:
